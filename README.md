...
You can use **Apache Maven** or **Gradle**/**Grails** to download the SDK.
   ...
   - Gradle/Grails
        ...
        ```gradle
        compile 'com.tencent.tcvectordb:vectordatabase-sdk-java:1.3.5'
        ```

### Examples

Please refer to [examples](./tcvectordb/src/com/tencent/tcvectordb/examples) folder for Java SDK examples.